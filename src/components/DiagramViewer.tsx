...
export function DiagramViewer({ diagrams }: { diagrams: Diagram[] }) {
  ...
  // All canvas interactions added imperatively so we can use passive:false
  useEffect(() => {
  ...
  return (
    <div className="flex h-full overflow-hidden bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        {/* Canvas — zoom/pan happens here */}
        <div
          ref={canvasRef}
          className="flex-1 overflow-hidden bg-[#f7f7f7] dark:bg-[#0c0c0c] cursor-grab active:cursor-grabbing"
